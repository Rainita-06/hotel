# Generated by Django 4.2.7 on 2025-11-03 11:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('building', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='locations', to='hotel_app.building')),
            ],
            options={
                'db_table': 'location',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('staff', 'Front Desk/Staff'), ('user', 'User')], default='user', max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='hotel_app.department')),
            ],
        ...
        migrations.AddField(
            model_name='location',
            name='floor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='locations', to='hotel_app.floor'),
        ),
        migrations.AddField(
            model_name='location',
            name='type',
